# Generated by Django 5.0.3 on 2024-07-16 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='creation date')),
                ('TelegramChatMessage_update_id', models.OneToOneField(db_column='TelegramChatMessage_update_id', on_delete=django.db.models.deletion.CASCADE, to='telegram.telegramchatmessage', verbose_name='chat message')),
            ],
            options={
